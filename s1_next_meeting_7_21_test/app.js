...
function inTodayPage() {
    ...
    .then(function (actionComplete) {

        // Notify in the log file that the action has been completed. 
        console.log("Done");

    }, function (error) { throw new Error("The promise for reading out next meeting fails. "); });
...
function lookupNextMeeting() {
    ...
    console.log("LookupNextMeeting: " + (endTime - startTime));
