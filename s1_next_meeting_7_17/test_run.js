...
function processsome(err, bytecount, buff) {
    ...
    if (lastLineFeed > -1) {
        ...
        for (var i = 0; i < lineArray.length; i++) {
            ...
            if (lineArray[i] === "Done") { // When we read a "Done" in the log file, stop reading
...
// Assume test.manifest is located in NarratorScripts folder
...
open_apps_outlook = exec('outlook.exe', function (error, stdout, stderr) {
    ...
    open_apps_narrator = exec('narrator.exe', function (error, stdout, stderr) {
