...
function setupSubjectNLocationForMeeting(startTime, endTime, meetingName, meetingRoom, testCallbackFunc) {
    ...
    .then(function (locationFieldValuePattern) {
        ...
        console.log("MEETING VALUE PAT: " + locationFieldValuePattern);

        ///////////////////////////////////////////////////////////////// PROBLEM /////////////////////////////////////////////////////////////////
        // PROBLEM: UNABLE TO SET SET THE VALUE FOR THE VALUE PATTERN OF LOCATION FIELD!!!
            ...
            function () {
                ...
                host.setTimeout(function () {
                    ...
                    if (meetingResultArray.length < 3) {
                        ...
                        assertOk(false, "FROM TEST.JS: LESS THAN 2 MEETINGS ARE ACTUALLY REPORTED - FROM TEST FOR 2 OVERLAPPED MEETINGS AND 1 NOT LEFT - WITH CONFLICTS");

                    } else if (meetingResultArray.length > 3) {

                        assertOk(false, "FROM TEST.JS: MORE THAN 2 MEETINGS ARE ACTUALLY REPORTED - FROM TEST FOR 2 OVERLAPPED MEETINGS AND 1 NOT LEFT - WITH CONFLICTS");

                    } else {

                        assertStrictEqual(meetingResultArray[0], "Here are your next meetings: ",
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - First sentence of the Narrator");

                        // First meeting
                        assertOk(meetingResultArray[1].indexOf("July 23, 2040,  from 9:00am to  10:00am") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Time of the first meeting");
                        assertOk(meetingResultArray[1].indexOf("Subject Meeting 1, Location Room 1") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Title and location of first meeting");
                        assertOk(meetingResultArray[1].indexOf("Organizer") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Organizer of first meeting");
                        assertOk(meetingResultArray[1].indexOf("Time") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Time of first meeting");


                        // Second meeting
                        assertOk(meetingResultArray[2].indexOf("July 23, 2040,  from 9:30am to  10:20am") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Time of the second meeting");
                        assertOk(meetingResultArray[2].indexOf("Subject Meeting 2, Location Room 2") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Title and location of second meeting");
                        assertOk(meetingResultArray[2].indexOf("Organizer") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Organizer of second meeting");
                        assertOk(meetingResultArray[2].indexOf("Time") > -1,
                            "Test for correctness of reading out next meetings -- two meetings with overlaps and one not - Time of second meeting");
                ...
                function () {
                    ...
                    host.setTimeout(function () {
                        ...
                        if (meetingResultArray.length < 3) {
                            ...
                            assertOk(false, "FROM TEST.JS: LESS THAN 2 MEETINGS ARE ACTUALLY REPORTED - FROM TEST FOR 2 OVERLAPPED MEETINGS LEFT - WITH CONFLICTS");

                        } else if (meetingResultArray.length > 3) {

                            assertOk(false, "FROM TEST.JS: MORE THAN 2 MEETINGS ARE ACTUALLY REPORTED - FROM TEST FOR 2 OVERLAPPED MEETINGS LEFT - WITH CONFLICTS");

                        } else {

                            assertStrictEqual(meetingResultArray[0], "Here are your next meetings: ",
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - First sentence of the Narrator");

                            // First meeting
                            assertOk(meetingResultArray[1].indexOf("July 23, 2040,  from 9:00am to  10:00am") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Time of the first meeting");
                            assertOk(meetingResultArray[1].indexOf("Subject Meeting 1, Location Room 1") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Title and location of first meeting");
                            assertOk(meetingResultArray[1].indexOf("Organizer") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Organizer of first meeting");
                            assertOk(meetingResultArray[1].indexOf("Time") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Time of first meeting");


                            // Second meeting
                            assertOk(meetingResultArray[2].indexOf("July 23, 2040,  from 9:30am to  10:20am") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Time of the second meeting");
                            assertOk(meetingResultArray[2].indexOf("Subject Meeting 2, Location Room 2") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Title and location of second meeting");
                            assertOk(meetingResultArray[2].indexOf("Organizer") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Organizer of second meeting");
                            assertOk(meetingResultArray[2].indexOf("Time") > -1,
                                "Test for correctness of reading out next meetings -- two meetings with overlaps - Time of second meeting");
            ...
            setupSubjectNLocationForMeeting("9:00 AM", "10:00 AM", "Meeting 1", "Room 1",
                ...
                function () {
                    ...
                    host.setTimeout(function () {
                        ...
                        // For unit testing
                        assertOk(narratorSentence.indexOf("July 23, 2040,  from 9:00am to  10:00am") > -1, "Test for the correctness of reading out next meeting - time");
                        assertOk(narratorSentence.indexOf("Subject Meeting 1, Location Room 1") > -1, "Test for the correctness of reading out next meeting - location");
                        assertOk(narratorSentence.indexOf("Organizer") > -1, "Test for the correctness of reading out next meeting - organizer");
                        assertOk(narratorSentence.indexOf("Time") > -1, "Test for the correctness of reading out next meeting - availability of organizer");
...
function testInAFutureDay() {
    ...
    .then(function (dayViewList) {
        ...
        host.setTimeout(function () {
            ...
            // Unit testing
            assertStrictEqual(narratorSentence, "You don't have a meeting today", "Test for no meeting");
